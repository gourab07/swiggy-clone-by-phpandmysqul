...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-12">
        <img style="display:block;margin: auto; width: 350px;height: 200px;" src="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2018/07/20/ZvENq7Ucxl4wdSQb3sBjnFTp/zips-for-upload/images/icon-1.png">
        <h1 class="text-md-center mt-3">Order Placed Successfully</h1>
      </div>
      <div class="col-12">
         <a href="orders.php" class="btn-success btn-lg text-md-center">Go to your Orders</a>
      </div>
    </div>
  </div>
