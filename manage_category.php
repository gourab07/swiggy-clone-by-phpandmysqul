...
<div class="container">
  <h3 class="text mt-5">Starters</h3>
  <div class="row mt-3">
  <?php
  $query = "SELECT * FROM food WHERE category LIKE '%Starters%'";
  $result = mysqli_query($conn,$query);
  while ($row = mysqli_fetch_assoc($result)){
    echo '<div class="col-3">
            <div class="card">
              <div class="card_body">
               <a href="food_details.php?id='.$row['food_id'].'"><img src="'.$row['img_path'].'" class="card-img"></a>
...
<div class="container">
  <h3 class="text mt-5">Main Course</h3>
  <div class="row mt-3">
  <?php
  $query = "SELECT * FROM food WHERE category LIKE '%Main Course%'";
  $result = mysqli_query($conn,$query);
  while ($row = mysqli_fetch_assoc($result)){
    echo '<div class="col-3">
            <div class="card">
...
<div class="container">
  <h3 class="text mt-5">Desserts</h3>
  <div class="row mt-3">
  <?php
  $query = "SELECT * FROM food WHERE category LIKE '%Desserts%'";
  $result = mysqli_query($conn,$query);
  while ($row = mysqli_fetch_assoc($result)){
    echo '<div class="col-3">
            <div class="card">
